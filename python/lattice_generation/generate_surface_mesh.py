...
def transform_mesh(
   path, thickness, max_volume_ratio, tesellation_option, cell_size, radius_edge_ratio 
):
...
if __name__ == "__main__":
    ...
    transform_mesh(path, thickness, max_volume_ratio, tesellation_option, cell_size, radius_edge_ratio)
